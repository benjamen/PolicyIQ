...
from app.fixtures.sample_data import load_sample_profiles
...
def compare_life_insurance(request: CompareRequest) -> CompareResponse:
    ...
    Currently backed by SYNTHETIC fixture data (see app/fixtures/sample_data.py)
    pending the crawler/extraction pipeline populating real, citation-verified
    ProductProfiles - `data_source` on the response makes this explicit so no
    caller mistakes fixture output for real policy data.
    """
